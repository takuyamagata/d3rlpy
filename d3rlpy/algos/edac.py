...
class EDAC(AlgoBase):
    r"""Ensemble Diversified Actor-Critic algorithm.

    EDAC is a SAC approach with diversified the ensembles of the critics
    value function estimation for offline RL settings.
    The model is implemented based on SAC algorithm and introduced a regularizer
    term to diversify the ensembles.
    ...
    Args:
        ...
        eta (float): scaling factor for ensemble similarity regularizer term.
