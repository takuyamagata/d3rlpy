...
from ...models.builders import (
    create_ted_continuous_q_function,
...
class TedDDPGBaseImpl(ContinuousQFunctionMixin, TorchImplBase, metaclass=ABCMeta):
    ...
    def _build_critic(self) -> None:
        self._q_func = create_ted_continuous_q_function(
...
class TedDDPGImpl(TedDDPGBaseImpl):
