...
__all__ = ["SeqIQLConfig", "SeqIQL"]


@dataclasses.dataclass()
class SeqIQLConfig(LearnableConfig):
    r"""
...
class SeqIQL(QLearningAlgoBase[SeqIQLImpl, SeqIQLConfig]):
    def inner_create_impl(
        ...
        self._impl = SeqIQLImpl(
            observation_shape=observation_shape,
            action_size=action_size,
            modules=modules,
            q_func_forwarder=q_func_forwarder,
            targ_q_func_forwarder=targ_q_func_forwarder,
            gamma_base=self._config.gamma_base,
...
register_learnable(SeqIQLConfig)
